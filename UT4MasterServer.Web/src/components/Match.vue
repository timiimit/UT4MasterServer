<template>
    <div class="list-group-item list-group-item-action" @click.stop="toggleShowPlayers">
        <div class="match">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>Elapsed Time: {{ toMinutesSeconds(match?.attributes.UT_MATCHDURATION_i) }}</div>
            </div>
        </div>
