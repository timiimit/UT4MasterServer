<template>
  ...
  <p>
    Use these instructions to configure a Hub you own or admin to use UT4 Master Server.
  </p>
  <ol>
    <li>Go to <span class="code">{UT4 Server Install Location}\UnrealTournament\Saved\Config\WindowsServer\</span> in
      file explorer</li>
